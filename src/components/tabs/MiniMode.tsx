...
export function MiniMode({ config, updateGroup, updateRule }: MiniModeProps) {
    return (
                        ...
                        <div className="flex items-center justify-between">
                            <Tooltip>
                                ...
                                <TooltipContent>
                                    <p>
                                        {group.collapsed
                                            ? t('tooltip_expand') || 'Expand'
                                            : t('tooltip_collapse') || 'Collapse'}
                                    </p>
                                </TooltipContent>
                            </Tooltip>
                                        ...
                                        <div key={rule.id} className="flex items-center justify-between text-sm">
                                            ...
                                            <Tooltip>
                                                ...
                                                <TooltipContent>
                                                    <p>
                                                        {rule.enabled
                                                            ? t('tooltip_disable_rule') || 'Disable Rule'
                                                            : t('tooltip_enable_rule') || 'Enable Rule'}
                                                    </p>
                                                </TooltipContent>
                                            </Tooltip>
                                        </div>
