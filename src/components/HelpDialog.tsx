import { HelpCircle, ExternalLink, Code, Zap, Hash, Link as LinkIcon } from 'lucide-react';
        ...
        <Dialog>
            ...
            <DialogContent className="sm:max-w-5xl h-[85vh] min-h-0 flex flex-col p-0">
                <DialogHeader className="p-6 pb-2">
                    ...
                    <DialogDescription>
                        {t('help_desc') ||
                            'Learn how to create powerful redirection rules using different matching modes.'}
                    </DialogDescription>
                </DialogHeader>
                ...
                <ScrollArea className="flex-1 min-h-0">
                    <div className="p-6 pt-0 space-y-8 pb-4">
                        ...
                        <section className="space-y-3">
                            ...
                            <p className="text-sm text-muted-foreground">
                                {t('help_wildcard_desc') ||
                                    'Use "*" to match any text. Each "*" value is available as $1, $2, etc., in the destination.'}
                            </p>
                            <div className="bg-muted/50 p-4 rounded-lg border space-y-2 text-sm">
                                <div className="grid grid-cols-[160px_1fr] gap-2">
                                    <span className="font-semibold text-muted-foreground">
                                    ...
                                    <code className="text-primary truncate font-mono">
                                ...
                                <div className="grid grid-cols-[160px_1fr] gap-2">
                                    ...
                                    <code className="text-primary truncate font-mono">
                                        https://$1.m.wikipedia.org/wiki/$2
                                    </code>
                                </div>
                                <div className="pt-2 border-t mt-2">
                                    <div className="flex items-center gap-2 text-xs text-muted-foreground mb-1">
                        ...
                        <section className="space-y-3">
                            ...
                            <p className="text-sm text-muted-foreground">
                                {t('help_pattern_desc') ||
                                    'Capture specific parts of the URL using ":name". Use {{name}} in the destination to insert them.'}
                            </p>
                            <div className="bg-muted/50 p-4 rounded-lg border space-y-2 text-sm">
                                <div className="grid grid-cols-[160px_1fr] gap-2">
                                    <span className="font-semibold text-muted-foreground">
                                ...
                                <div className="pt-2 border-t mt-2">
                                    ...
                                    <div className="flex flex-wrap gap-x-2 gap-y-1 items-center font-mono text-xs">
                                        <span className="line-through opacity-50">
                                            ...github.com/danidoble/redirector
                                        </span>
                                        <span className="text-primary">→</span>
                                        <span className="font-bold text-primary">
                                            ...gitlab.com/danidoble/redirector
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <section className="space-y-3">
                            ...
                            <p className="text-sm text-muted-foreground">
                                {t('help_regex_desc') ||
                                    'Full power of JavaScript Regular Expressions. Use capture groups () and $1, $2 to reference them.'}
                            </p>
                            <div className="bg-muted/50 p-4 rounded-lg border space-y-2 text-sm">
                                <div className="grid grid-cols-[160px_1fr] gap-2">
                                    <span className="font-semibold text-muted-foreground">
                                ...
                                <div className="pt-2 border-t mt-2">
                                    ...
                                    <div className="flex flex-wrap gap-x-2 gap-y-1 items-center font-mono text-xs">
                                        ...
                                        <span className="text-primary">→</span>
                                        <span className="font-bold text-primary">
                                            ...smile.amazon.com/dp/B00X4WHP5E
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <section className="space-y-3">
                            ...
                            <p className="text-sm text-muted-foreground">
                                {t('help_decode_desc') ||
                                    'When enabled, captured values (like $1 or {{name}}) will be decoded (URI unescaped) before being inserted into the destination.'}
                            </p>
                            <div className="bg-primary/5 p-4 rounded-lg border border-primary/20 text-sm">
                                <p className="text-xs font-medium text-primary mb-2 uppercase tracking-wider">
                                    {t('help_example_result') || 'Example result'}:
                                </p>
                                ...
                                <p className="mt-3 text-xs text-muted-foreground italic">
                                    {t('help_decode_example_desc') ||
                                        "For example, if the URL contains '%3A%2F%2F', decoding will convert it to '://'."}
                                </p>
                            </div>
                        </section>
                        ...
                        <section className="space-y-3">
                            ...
                            <p className="text-sm text-muted-foreground">
                                {t('help_groups_desc') ||
                                    'Groups allow you to organize your rules. Disabling a group will disable all rules within it.'}
                            </p>
                        </section>
                        ...
                        <section className="space-y-3">
                            ...
                            <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
                                <li>
                                    {t('help_tips_order') ||
                                        'Order matters: Rules are processed from top to bottom. The first rule that matches will be applied.'}
                                </li>
                                <li>
                                    {t('help_tips_testing') ||
                                        "Test your rules: Use the 'Test URL' field in the rule editor to verify your patterns before saving."}
                                </li>
                            </ul>
                        </section>
                    </div>
